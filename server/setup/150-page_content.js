...
if (_val.global().getBoolean('cluar:setup')) {
    _db.insertIfNotExists(
        ...
        _val.init()
            ...
            .set("image", "")
            .set("image_title", "")
            .set("title", '<p><span style="color: rgb(0, 0, 0); background-color: rgba(255, 255, 255, 0); font-size: 32px; font-family: inherit;">Documentation</span></p>')
            .set("sorter", 20)
    ...
    _db.insertIfNotExists(
        ...
        _val.init()
            ...
            .set("image", "")
            .set("image_title", "")
            .set("title", '<p><span style="color: rgb(0, 0, 0); background-color: rgba(255, 255, 255, 0); font-size: 32px; font-family: inherit;">Open Source & Community</span></p>')
            .set("sorter", 30)
            .set("image_max_width", 0)
            .set("image_alt", "")
    ...
    _db.insertIfNotExists(
        ...
        _val.init()
            ...
            .set("image", "")
            .set("image_title", "")
            .set("title", '<p><span style="color: rgb(0, 0, 0); background-color: rgba(255, 255, 255, 0); font-size: 32px; font-family: inherit;">Documenta\\u00E7\\u00E3o</span></p>')
            .set("sorter", 20)
            .set("image_max_width", 0)
            .set("image_alt", "")
    ...
    _db.insertIfNotExists(
        ...
        _val.init()
            ...
            .set("image", "")
            .set("image_title", "")
            .set("title", '<p><span style="color: rgb(0, 0, 0); background-color: rgba(255, 255, 255, 0); font-size: 32px; font-family: inherit;">C\\u00F3digo Aberto & Comunidade</span></p>')
            .set("sorter", 30)
            .set("image_max_width", 0)
            .set("image_alt", "")
