...
const SortableItem = ({
  ...
  const handleSaveTitleModal = () => {
    ...
    message.success(
      Cluar.plainTranslation("sortable-col-item-notification-title-success"),
    );
  };
  ...
  const handleSaveContentModal = () => {
    ...
    message.success(
      Cluar.plainTranslation("sortable-col-item-notification-content-success"),
    );
  };
  ...
  return (
    <>
      ...
      <Modal
          ...
          >
            ...
            <Space>
              <span style={{ fontSize: "12px", fontWeight: "normal" }}>
                {Cluar.plainTranslation("sortable-col-item-invert-background")}
              </span>
              <Switch
                checked={titleInvert}
        ...
        width={1000}
        okText={Cluar.plainTranslation("sortable-col-item-modal-save")}
        cancelText={Cluar.plainTranslation("sortable-col-item-modal-cancel")}
        centered
        destroyOnHidden
        maskClosable={false}
      >
            ...
            <Space>
              ...
              >
                <Radio.Button value="visual">
                  {Cluar.plainTranslation("sortable-col-item-mode-visual")}
                </Radio.Button>
                <Radio.Button value="html">
                  {Cluar.plainTranslation("sortable-col-item-mode-code")}
                </Radio.Button>
              </Radio.Group>
