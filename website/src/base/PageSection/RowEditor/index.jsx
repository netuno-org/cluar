...
const RowEditor = ({ sectionData, form }) => {
  ...
  useEffect(() => {
    _service({
      url: "/reserved-area/component/listing/list",
      method: "POST",
      data: {
  ...
  return (
    <div className="row-editor">
      <Form.Item
        label={Cluar.plainDictionary("row-editor-field-type")}
        name="type"
      >
        <Select
      ...
      {showActions && (
        ...
        >
          <Select
            ...
            placeholder={Cluar.plainDictionary("row-editor-placeholder-add")}
            mode="multiple"
            allowClear
          />
        </Form.Item>
      ...
      <Row gutter={[12, 12]}>
        ...
        <Col span={24}>
          <Button onClick={handleAddItem}>
            {Cluar.plainDictionary("row-editor-button-new-item")}
          </Button>
        </Col>
      </Row>
    </div>
