...
const MemberFormModal = forwardRef(({ onReloadTable, memberData, userData }, ref) => {
  ...
  return (
    <Modal
      title={editMode ? Cluar.plainTranslation('member-modal-edit-title') : Cluar.plainTranslation('member-modal-new-title') + "a"}
      open={isModalOpen}
