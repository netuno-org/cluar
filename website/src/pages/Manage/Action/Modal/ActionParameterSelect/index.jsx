...
const ActionParameterSelect = ({ value, onChange }) => {
  ...
  const loadParameters = () => {
    setLoading(true);
    _service({
      url: "reserved-area/action/parameter/list",
      method: "POST",
      success: (response) => {
        setLoading(false);
  ...
  const saveCreate = () => {
    ...
    _service({
      url: "reserved-area/action/parameter",
      method: "POST",
      data: createDraft,
      success: (response) => {
    ...
    _service({
      ...
      fail: (error) => {
        ...
        const errorMessage =
          ...
          || error?.json?.error
          || Cluar.plainTranslation("action-parameter-select-notification-delete-fail");
  ...
  return (
    <Select
      className="action-parameter-select"
      value={value}
      open={open}
      ...
      dropdownRender={() => (
        ...
        >
          <div className="action-parameter-select-list">
            ...
            {filteredParameters.map((parameter) =>
              editingUid === parameter.uid ? (
                <div className="action-parameter-select-row editing" key={parameter.uid}>
                  <Input
                    size="small"
                ...
                <div
                  className={`action-parameter-select-row ${value === parameter.uid ? "selected" : ""
                    }`}
                  key={parameter.uid}
                  onClick={() => {
          ...
          {creating ? (
            <div className="action-parameter-select-row creating">
              <Input
                size="small"
...
export default ActionParameterSelect;
